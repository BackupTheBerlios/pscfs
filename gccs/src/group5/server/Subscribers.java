 ...
 * This collection works as a database for collecting all subscribers in the system.
 * Service can access this databse through functions:
 * <ol>
 ...
 * <li>getSubscriber() to get subscriber in collection associated given a subscriber ID
 * </ol>
...
public class Subscribers {
	 ...
	 * @param subscriberAddress Address of the new subscriber
	 ...
	 * @param subscrID ID of the subscriber
	 */
	public synchronized Subscriber getSubscriber(int subscrID)
	{
		Subscriber sub = (Subscriber) m_listSubscribers.get(new Integer(subscrID));
		return sub;
	}
	/**
