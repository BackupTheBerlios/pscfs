...
public class CommonFuntions {
    ...
    /**
     * The following method is to convert from a String of hexidecimal
     * digits to an array of bytes.
     */
    static public byte[] stringToHexBytes(String s) throws IllegalArgumentException {
        try {
            s = s.toLowerCase();
            int len = s.length();
            ...
            throw new IllegalArgumentException("stringToHexBytes(): invalid input");
        }
    }
}
