//$Id: CallControlException.java,v 1.4 2005/06/12 22:46:51 huuhoa Exp $
package group5;
...
public final class CallControlException extends GeneralException {
	...
	public String toString() {
		...
		if (type < 0 || type >= exceptionTypes.length)
			type = 0;
		return "CallControlException: " + exceptionTypes[type] + " "
				+ super.toString();
	}
	...
	private static final String exceptionTypes[] = { "Failure",
			"Unknown event", "Invalid parameter(s)", "Invalid ID", "Timeout",
			"Invalid Address", "Invalid Network state" };
